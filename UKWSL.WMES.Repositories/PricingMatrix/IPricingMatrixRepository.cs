...
namespace UKWSL.WMES.Repositories.PricingMatrix
{
    public interface IPricingMatrixRepository
    {
        ...
        PricingMatrixUploadInfo UploadPricingMatrixDetailRawData(PricingMatrixUploadInfo matrixUploadInfo, DataTable dataTable);
        ...
        PriceUpdateUploadInfo PricingUpdateUploadInsertRawData(PriceUpdateUploadInfo pricingUpdateUploadInfo, DataTable dataTable);
