...
using IAuthenticationManager = UKWSL.WMES.Business.Authentication.IAuthenticationManager;
...
namespace UKWSL.WMES.WEBAPP.WebHelper
{
    public class AppOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        private IAuthenticationManager databaseManager;
        #endregion
        ...
        public AppOAuthProvider(string publicClientId)
        {
            ...
            databaseManager = new AuthenticationManager();
            // Settings.
        ...
        public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            var user = this.databaseManager.GetLoggedInUser(usernameVal, passwordVal);
            ...
            AuthenticationProperties properties = CreateProperties(userInfo);
